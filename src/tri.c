...
int tri_clipAgainstPlane(tri_t *outTris, v3_t planePoint, v3_t planeNormal, tri_t inTri)
{
    ...
    v2_t insideTexPoints[3];
    v2_t outsideTexPoints[3];
    ...
    if (p0Inside)
    {
        ...
        insideTexPoints[numInsidePoints] = inTri.t[0];
        numInsidePoints++;
    }
    else
    {
        outsidePoints[numOutsidePoints] = inTri.p[0];
        outsideTexPoints[numOutsidePoints] = inTri.t[0];
        numOutsidePoints++;
    }
    ...
    if (p1Inside)
    {
        ...
        insideTexPoints[numInsidePoints] = inTri.t[1];
        numInsidePoints++;
    }
    else
    {
        outsidePoints[numOutsidePoints] = inTri.p[1];
        outsideTexPoints[numOutsidePoints] = inTri.t[1];
        numOutsidePoints++;
    }
    ...
    if (p2Inside)
    {
        ...
        insideTexPoints[numInsidePoints] = inTri.t[2];
        numInsidePoints++;
    }
    else
    {
        outsidePoints[numOutsidePoints] = inTri.p[2];
        outsideTexPoints[numOutsidePoints] = inTri.t[2];
        numOutsidePoints++;
    }
    ...
    if (numInsidePoints == 1)
    {
        ...
        outTris[0].t[0] = insideTexPoints[0];
        ...
        outTris[0].t[1] = v2_interpolate(insideTexPoints[0], outsideTexPoints[0], t);
        ...
        outTris[0].t[2] = v2_interpolate(insideTexPoints[0], outsideTexPoints[1], t);
    ...
    if (numInsidePoints == 2)
    {
        ...
        outTris[0].t[1] = insideTexPoints[1];

        t = v3_getPlaneIntersect(planePoint, planeNormal, insidePoints[0], outsidePoints[0]);
        outTris[0].p[2] = v3_interpolate(insidePoints[0], outsidePoints[0], t);
        outTris[0].t[2] = v2_interpolate(insideTexPoints[0], outsideTexPoints[0], t);

        // tri 2
        outTris[1].p[0] = insidePoints[1];
        outTris[1].t[0] = insideTexPoints[1];
        ...
        outTris[1].t[1] = v2_interpolate(insideTexPoints[1], outsideTexPoints[0], t);
